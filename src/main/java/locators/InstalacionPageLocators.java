...
public interface InstalacionPageLocators {
    ...
    By DESPLEGAR_SERVICIOS=By.xpath("//*[@id=\"solucionVendida:j_idt85:serviciosAdicionales\"]/div[3]");
    By CHECKBOX_SERVICIO_GPS=By.xpath("//*[@id=\"solucionVendida:j_idt85:serviciosAdicionales_1\"]");

    By GUARDAR_NUEVO_SERVICIO=By.id("solucionVendida:j_idt85:j_idt131");
