...
//        "SELECT serie, codigo, modelo, me.empresa"
    ...
    public static JSONArray obtenerPolizaVigente(String Dominio) {
        String query =
                "SELECT *"
                        + " FROM vehiculos v"
                        + " INNER JOIN vehiculosPorCliente vpc on v.idVehiculo = vpc.idVehiculo"
                        + " INNER JOIN detallePolizas dp on dp.idDetallePoliza = vpc.idDetallePoliza"
                        + " WHERE v.dominio = '<dominio>'";


        query = query.replace("<dominio>", Dominio);
    ...
    public static JSONArray obtenerChasisyMotor(String dominio) {
        String query =
                "SELECT  chasis, motor"
                        + " FROM vehiculos"
